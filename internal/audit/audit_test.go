...
func TestAnalyzeTracksPostflopDisciplineAndHistoricalSpecialBarrels(t *testing.T) {
	path := filepath.Join(t.TempDir(), "ainp.jsonl")
	content := "" +
		`{"msg":"strategy_decision","decision_id":"capped-bet","table_id":"t","hand_id":"50","player_id":"normal","street":"river","action":"bet","hand_category":2,"one_pair_below_top_board":true}` + "\n" +
		`{"msg":"strategy_decision","decision_id":"capped-guard","table_id":"t","hand_id":"51","player_id":"normal","street":"river","action":"check","rule_id":"POSTFLOP_CAPPED_PAIR_POT_CONTROL","hand_category":2,"one_pair_below_top_board":true}` + "\n" +
		`{"msg":"strategy_decision","decision_id":"straight-call","table_id":"t","hand_id":"70","player_id":"normal","street":"turn","action":"call","hand_category":2,"four_to_straight_board":true}` + "\n" +
		`{"msg":"strategy_decision","decision_id":"straight-guard","table_id":"t","hand_id":"71","player_id":"normal","street":"turn","action":"fold","rule_id":"POSTFLOP_FOUR_STRAIGHT_FOLD","hand_category":2,"four_to_straight_board":true}` + "\n" +
		`{"msg":"strategy_decision","decision_id":"paired-bet","table_id":"t","hand_id":"90","player_id":"normal","street":"river","action":"allin","hand_category":3,"paired_board_two_pair":true}` + "\n" +
		...
		`{"msg":"strategy_decision","decision_id":"flush-pair-raise","table_id":"t","hand_id":"92","player_id":"normal","street":"turn","action":"raise","rule_id":"POSTFLOP_VALUE_RAISE","hand_category":2,"three_to_flush_board":true}` + "\n" +
		...
		`{"msg":"strategy_decision","decision_id":"river-pair-reraise","table_id":"t","hand_id":"94","player_id":"normal","street":"river","raises_faced":1,"action":"allin","rule_id":"POSTFLOP_ALLIN_VALUE","hand_category":2}` + "\n" +
		`{"msg":"strategy_decision","decision_id":"river-pair-guard","table_id":"t","hand_id":"95","player_id":"normal","street":"river","raises_faced":1,"action":"fold","rule_id":"RIVER_ONE_PAIR_RERAISE_FOLD","hand_category":2}` + "\n" +
		...
		`{"msg":"strategy_decision","decision_id":"special-turn","table_id":"t","hand_id":"116","player_id":"special","audit_exempt":true,"street":"turn","action":"bet","hand_class":"air"}` + "\n" +
