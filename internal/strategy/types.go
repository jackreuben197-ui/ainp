...
type ProfitControl struct {
	Enabled                 bool
	MinimumActions          int
	LargeActionBB           float64
	LargeActionStackRatio   float64
	ProfitTriggerBB         float64
	ProfitTriggerStackRatio float64
	LossTriggerBB           float64
	LossTriggerStackRatio   float64
	CallRateTarget          float64
	AggressionRateTarget    float64
	MaxExposureMargin       float64
	MaxPerformanceMargin    float64
	MaxActionMixMargin      float64
	MaxTotalMargin          float64
}
...
type Features struct {
	...
	PairedBoardTwoPair         bool
	MadeCategoryFromBoard      bool
	FourToStraightBoard        bool
	ThreeToFlushBoard          bool
...
type Decision struct {
	...
	ProfitControl ProfitControlMetrics
}

type ProfitControlMetrics struct {
	Applied           bool
	ActionBB          float64
	ActionStackRatio  float64
	ProfitBB          float64
	ProfitStackRatio  float64
	CallRate          float64
	AggressionRate    float64
	ExposureMargin    float64
	PerformanceMargin float64
	ActionMixMargin   float64
	TotalMargin       float64
}
